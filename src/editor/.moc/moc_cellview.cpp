...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CellView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CellView_t qt_meta_stringdata_CellView = {
    {
QT_MOC_LITERAL(0, 0, 8) // "CellView"
...
static const uint qt_meta_data_CellView[] = {
...
QT_INIT_METAOBJECT const QMetaObject CellView::staticMetaObject = { {
    &BaseGraphicsView::staticMetaObject,
    qt_meta_stringdata_CellView.data,
